...
# possibilities = (virus_kmers["omicron"] & virus_kmers["delta"] & virus_kmers["alpha"]) - virus_kmers["wuhan"]
possibilities = virus_kmers["omicron"].intersection(virus_kmers["delta"], virus_kmers["alpha"]).difference(virus_kmers["wuhan"])
